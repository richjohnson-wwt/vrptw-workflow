...
class TestGeocodingCache:
    ...
    def test_connect_creates_schema(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Verify index exists
            cur.execute("SELECT name FROM sqlite_master WHERE type='index' AND name='idx_addresses_norm'")
            assert cur.fetchone() is not None
    ...
    def test_clear_by_state(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            cache.put("123 Main St, Springfield, IL 62701, USA", 39.78, -89.65, "Springfield, IL", source="nominatim")
            cache.put("456 Oak Ave, Chicago, IL 60601, USA", 41.88, -87.63, "Chicago, IL", source="nominatim")
            cache.put("789 Pine Rd, Los Angeles, CA 90001, USA", 34.05, -118.24, "Los Angeles, CA", source="nominatim")
            cache.put("321 Elm St, San Francisco, CA 94102, USA", 37.77, -122.42, "San Francisco, CA", source="nominatim")
    ...
    def test_get_cache_stats_by_state(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Store addresses in different states
            cache.put("123 Main St, Springfield, IL 62701, USA", 39.78, -89.65, "Springfield, IL", source="nominatim")
            cache.put("456 Oak Ave, Chicago, IL 60601, USA", None, None, "", source="none")  # Failed
            cache.put("789 Pine Rd, Los Angeles, CA 90001, USA", 34.05, -118.24, "Los Angeles, CA", source="nominatim")
